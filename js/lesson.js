...
<<<<<<< HEAD
      message = "<h3>SAT's</h3><p>SAT stands for Standard Attainment Test. These end of year assessments take place at the end of Key Stage 2, and test a student’s ability in Maths, English and Science so they’ll be in the best place when they start Secondary School. Teachers use the results from these tests to assign ‘aspirational’ (or target) grades to students, placing them in the lesson groups that will best allow them to achieve those targets. <br><br> While Olivia begins to prepare students throughout their Key Stage 1-2 lessons, SAT’s preparation focuses on the tests themselves.  Using a combination of mock SAT tests and support lessons to evaluate a students strengths and work on their weaknesses. SAT’s can be a stressful time for a young student, as the pressure from schools is often fuelled by a need for favourable results (SAT’s results directly affect a schools ranking). Having someone to support and guide your child through the pressure can help to make him or her feel relaxed and in control.</p>";
=======
      message = "<h3>SAT's</h3><p>SAT stands for Standard Attainment Test. These end of year assessments take place at the end of Key Stage 2, and test a student’s ability in Maths, English and Science so they’ll be in the best place when they start Secondary School. Teachers use the results from these tests to assign ‘aspirational’ (or target) grades to students, placing them in the lesson groups that will best allow them to achieve those targets. <br><br> While Olivia begins to prepare students throughout their Key Stage 1-2 lessons, SAT’s preparation focuses on the tests themselves, using a combination of mock SAT tests and support lessons to evaluate a students strengths and work on their weaknesses. SAT’s can be a stressful time for a young student, as the pressure from schools is often fuelled by a need for favourable results (SAT’s results directly affect a schools ranking). Having someone to support and guide your child through the pressure can help to make him or her feel relaxed and in control.</p>";
>>>>>>> fcc49fda4e9825bebb7b77c9302699e851199d74
    text();
